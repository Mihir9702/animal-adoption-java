package com.animaladoption.animaladoption;
...
public class TestingDatabaseConfig {
  ...
  private static final String DB_HOST = Objects.requireNonNullElse(
      System.getenv("DB_HOST"), "localhost");
  private static final String DB_PORT = Objects.requireNonNullElse(
      System.getenv("DB_PORT"), "5432");
  private static final String DB_NAME = Objects.requireNonNullElse(
      System.getenv("DB_NAME"), "animal-adoption-test");
  private static final String DB_USER = Objects.requireNonNullElse(
      System.getenv("DB_USER"), "postgres");
  private static final String DB_PASSWORD = Objects.requireNonNullElse(
  ...
  public void setup() {
    if (System.getenv("DB_HOST") == null) {
      ...
      adminDataSource.setPassword("postgres");
